...
return [
    ...
    'helpers' => [
        ...
        'role_super_admin_only' => 'المسؤول الأعلى وحده من يمنح صلاحية المسؤول أو يسحبها.',
        'deleted_account' => 'هذا الحساب محذوف. استعِده أولًا قبل تعديل أي شيء فيه.',
    ],

    'super_admin' => [
        'badge' => 'المسؤول الأعلى',
        'protected' => 'محدَّد عبر SUPER_ADMIN_EMAIL في إعدادات الخادم. لا يمكن إلغاء تفعيل هذا الحساب أو خفض دوره أو حذفه من هنا.',
        'role_locked' => 'يُحدَّد في الخادم لا هنا: هذا الحساب مسؤول لأن SUPER_ADMIN_EMAIL يشير إليه.',
        'status_locked' => 'يُحدَّد في الخادم لا هنا: يبقى هذا الحساب نشطًا لأن SUPER_ADMIN_EMAIL يشير إليه.',
    ],
