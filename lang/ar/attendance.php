...
return [
    ...
    'page' => [
        ...
        /*
         | الجملة تحت الحالة. تذكر وقت بداية الحالة حتى يقارنها الموظف بما
         | يتذكره من صباحه بدلًا من الاكتفاء بكلمة واحدة.
         */
        'state_caption' => [
            'not_checked_in' => 'اضغط «تسجيل الحضور» عند وصولك إلى موقع الشركة.',
            'checked_in' => 'جلستك مفتوحة منذ :time.',
            'checked_out' => 'آخر انصراف لك اليوم كان الساعة :time.',
        ],
        'sessions_heading' => 'جلسات اليوم',
        'sessions_empty' => 'لم تسجّل حضورك اليوم بعد.',
        'session_number' => 'الجلسة :number',
        // نهاية الجلسة الوحيدة التي لم تنتهِ بعد في المخطط الزمني.
        'session_open' => 'الآن',
    ...
    'history' => [
        'heading' => 'سجل الحضور',
        // توضيح معنى السطر الواحد، فاليوم الذي تتخلله استراحة ينتج عدة أسطر
        // قد تبدو دون ذلك مكررة.
        'description' => 'سطر لكل جلسة، والأحدث أولًا.',
